...
public class Division extends OperacionMatematicaBinaria {
    ...
    public String generarCodigo(GeneradorCodigo generadorCodigo) {
        ...
        String instruccion = this.getTipoDato() == TipoDato.FLOAT ? "fdiv double" : "sdiv i32";

        // Código ejemplo:
        // %puntero.1 = fdiv double 0.0, 3.14
        // %puntero.2 = fdiv double 0.0, 2.71
        // %puntero.3 = fdiv double %puntero.1, %puntero.2
